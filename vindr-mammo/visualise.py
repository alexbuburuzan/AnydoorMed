...
if __name__ == "__main__":
    dicom_path = "../data/vindr-mammo/images/0a0c5108270e814818c1ad002482ce74/0a6a90bdc088e0cc62df8d2d58d14840.dicom"
    png_img = convert_dicom_to_png(dicom_path)
    plt.imshow(png_img, cmap="gray")
    plt.show()
    # save the image in dump folder given dicom_path file name
    plt.imsave(f"../dump/{dicom_path.split('/')[-1].replace('.dicom', '.png')}", png_img, cmap="gray")